...
const PRODUCTS = [
    ...
    },
    {
        ...
        title: "All-in-One i5",
        category: "computadores",
        subcategory: "computadores-office",
        price: 3999,
        stock: 3,
    ...
    const CATEGORIES_MAP = [
        ...
        },
        {
            value: "hardware", keywords: ["placa de vídeo", "gpu", "processador", "cpu", "placa mãe", "memória ram", "ssd", "hd", "fonte", "gabinete", "cooler", "water cooler", "fan"], subcategories: [
                { value: "gpu", keywords: ["placa de vídeo", "gpu"] },
                { value: "cpu", keywords: ["processador", "cpu"] },
                { value: "motherboard", keywords: ["placa mãe"] },
                { value: "mram", keywords: ["memória ram"] },
                { value: "armazenamento", keywords: ["ssd", "hd", "m.2"] },
                { value: "fontes", keywords: ["fonte"] },
                { value: "gabinetes", keywords: ["gabinete"] },
                { value: "coolers", keywords: ["cooler", "water cooler", "fan"] },
            ]
        },
    ];
