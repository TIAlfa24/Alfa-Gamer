...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const productId = parseInt(urlParams.get('id')) || PRODUCTS[0].id;
    const product = PRODUCTS.find(p => p.id === productId) || PRODUCTS[0];

    // ... (seu código que preenche preço, nome, imagens, etc) ...

    // === ADICIONE ESTA LINHA AQUI ===
    // Isso chama o avaliações.js filtrando pelo ID deste produto
